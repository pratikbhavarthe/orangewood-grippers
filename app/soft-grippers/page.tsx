          ...
          {[
            {
              ...
              images: ["/3.jpeg", "/3_1.jpeg"],
              description: "Delicate precision for smaller objects.",
            },
            {
              title: "5-Finger Gripper",
              images: ["/5_1.jpeg", "/5_2.jpeg"],
              description: "Versatile handling for a range of objects.",
            },
            {
              title: "6-Finger Gripper",
              images: ["/6_1.jpeg", "/6_2.jpeg"],
              description: "Heavy-duty gripping for industrial applications.",
            },
          ].map((gripper, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              ...
              <div className="w-full max-w-sm p-6 rounded-xl shadow-md text-center mb-4">
                {/* Carousel for Gripper */}
                <Carousel>
                  <CarouselContent>
                    {gripper.images.map((image, idx) => (
                      <CarouselItem key={idx}>
                        <div className="w-[320px] h-[350px] mx-auto">
                          <Image
                            src={image}
                            alt={`${gripper.title} ${idx + 1}`}
                            width={350}
                            height={350}
              ...
              <p className="text-gray-300 text-sm mt-4 min-h-[3rem] flex items-center justify-center">
                {gripper.description}
              </p>
            </div>
          ))}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 text-center justify-items-center">
            ...
            <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-md border border-gray-300">
              ...
              <p className="text-gray-500 text-sm text-center">
                Perfect for food handling, ensuring that delicate items such as
                fruits, pastries, and packaged goods remain intact.
              </p>
            </div>
          </div>
        </div>
